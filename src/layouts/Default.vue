<template>
  ...
  >
    ...
    <div class="flex-grow bg-background-secondary">
      <slot />
    </div>
    <footer :class="theme">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div :class="theme" class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. All rights reserved.</div>
          <div>
            <a href="/rss.xml" :class="theme" class="font-normal">RSS Feed</a> |
            <a href="/sitemap.xml" :class="theme" class="font-normal">Sitemap</a>
          </div>
        </div>
